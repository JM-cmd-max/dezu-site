        ...
        <div className="product-content">
          <div className="section section-bg-prst1">
            ...
            <div className="column text-column rajdhani-semibold">
              <p className='pt-rc'>Designed for precise and reliable high-pressure testing across various applications. Its robust, compact design offers efficient performance while simplifying maintenance for prolonged durability.</p>
              <ul>
