    ...
    return (
      ...
      <div className="section section-bg-prst1">
            <div className="column">
              <p className='barcode left-spacing'>NLB 225 SERIES WATER JETTING PUMP</p>
            ...
            <div className="column1 text-column rajdhani-semibold">
              <p className='list-paragraph-1'>powerhouse in hydro demolition, expertly engineered to deliver water efficiently to the accessory for precise material removal. Its robust design ensures consistent high-pressure performance, making it an ideal choice for demanding demolition projects. </p>
              <ul>
      ...
      <div className="section-imgtxt2 text-column rajdhani-semibold">
          <p  className='list-paragraph-2'>Durable and flexible accessory for manual hydro demolition, ensuring precise water delivery and reliable performance in tough environments. Lightweight and easy to handle, it enhances productivity and maintains safety standards.</p>
          <ul>
