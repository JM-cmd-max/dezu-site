    ...
    <div className="text-table-wglitch-wj3 cleaning-bg">
      ...
      <div className="center-container">
        ...
        <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-1'>Designed to keep high-pressure water jetting equipment operating at peak performance. A powerful tool for heavy-duty cleaning and hydro demolition tasks, ensuring reliable and efficient operation in the most demanding environments</p>
          <ul>
      ...
      <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-2'>A versatile, cordless vacuum designed for both mobility and performance. With powerful suction and HEPA filtration, it effectively handles demanding cleaning tasks while its compact, durable design ensures ease of use in any environment.</p>
          <ul>
      ...
      <div className="section section-ct1">
        ...
        <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-1'>Powerful, high-airflow units designed for versatile industrial applications, including metalworking, plastics, electronics, and more. Featuring high-efficiency filtration, large dust collection capacity, and flexible configuration options.</p>
          <ul>
