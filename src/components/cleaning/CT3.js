...
const CT3 = () => {
  ...
  return (
    <div className="text-table-wglitch-wj6 cleaning-bg">
      ...
      <div className="center-container">
        ...
        <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-1'>Designed to tackle tough clogs with its powerful cleansing capability and high-torque motor. Its compact size and durable construction make it perfect for both residential and commercial use, while the long cable length and user-friendly controls ensure efficiency and ease of use.</p>
          <ul>
      ...
      <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-2'>Offers high-pressure performance and advanced jet technology for efficient and precise cleaning. Constructed with durable materials and featuring versatile attachments, it is both user-friendly and easy to maneuver</p>
          <ul>
    ...
    <div className="divider"></div>
      ...
      <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-2'>Combines powerful suction with advanced filtration for efficient and thorough cleaning. Its compact design and durable build ensure it performs well in tight spaces and withstands frequent use.</p>
          <ul>
