    ...
    <div className="text-table-wglitch-wj3 cleaning-bg">
      ...
      <div className="center-container">
        ...
        <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-1'>Features smart navigation and high suction power for thorough and efficient cleaning in complex environments. Its compact design, long battery life, and user-friendly controls enhance usability, while the durable construction and quiet operation ensure reliable performance. </p>
          <ul>
      ...
      <div className="column text-column rajdhani-semibold">
          <p  className='list-paragraph-2'>Engineered for efficiency, offering powerful sweeping and advanced dust control to handle large areas with ease. Its compact size and durable build ensure reliable performance in various environments, while the quiet operation and long battery life enhance overall user experience. </p>
          <ul>
