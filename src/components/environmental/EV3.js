        ...
        <div className="product-content">
          <div className="section section-bg-prst3">
            ...
            <div className="column text-column rajdhani-semibold">
              <p className='list-paragraph-1'>Deliver high-purity water by removing contaminants through advanced multi-stage filtration. Their energy-efficient, compact design ensures cost-effective operation and easy installation, while durable construction guarantees reliable, long-term performance.</p>
              <ul>
