        ...
        <div className="product-content">
          <div className="section section-bg-prst3">
            ...
            <div className="column text-column rajdhani-semibold">
              <p className='list-paragraph-1'>Designed to significantly reduce noise levels through effective sound absorption, using durable and eco-friendly materials. Their customizable design and aesthetic appeal ensure they meet diverse architectural needs while providing easy installation and low maintenance. </p>
              <ul>
